 ...
 * results.php
 * 
 * This file displays the calculated rest recommendations and personalized advice to users.
 * It presents the results in a user-friendly interface with detailed analysis and research-backed
 * recommendations.
 * 
 * Key features:
...
try {
    // Get and validate results from session
...
<body class="flex items-center justify-center min-h-screen relative font-['Inter'] bg-gradient-to-br from-green-50 to-green-100">
    ...
    <div class="container mx-auto px-4 py-20 flex flex-col lg:flex-row lg:space-x-8 space-y-8 lg:space-y-0">
        ...
        <div class="bg-white/95 backdrop-blur-md border border-white/20 p-8 rounded-2xl shadow-2xl w-full lg:order-1">
            ...
            <div class="space-y-4">
                <?php
                // Display injury-specific recommendations
                if ($isInjury) {
                ...
                // Display age-specific recommendations
                if ($age >= 65) {
                ...
                // Display score-based recommendations
                if ($score < 0.6) {
                ...
                // Display protein intake recommendations
        ...
        <div class="bg-white/95 backdrop-blur-md border border-white/20 p-8 rounded-2xl shadow-2xl w-full lg:order-3">
            ...
            <div class="space-y-4">
                ...
                <?php 
                // Display hydration research if water intake is low
                if (isset($result['waterIntake']) && $result['waterIntake'] < ($weight * 0.02)): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php 
                // Display sleep research if sleep is insufficient
                if (isset($result['sleep']) && $result['sleep'] < 7): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php 
                // Display protein research if intake is low
                if (isset($result['proteinIntake']) && $result['proteinIntake'] < ($weight * 0.8)): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php 
                // Display intensity research for high-intensity workouts
                if (isset($result['intensity']) && $result['intensity'] === 'high'): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php 
                // Display injury research if user is injured
                if ($isInjury): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <!-- General research about longer breaks -->
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php 
                // Display high frequency research if rest days are low
                if ($result['rest'] < 5): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php 
                // Display age-specific research for users over 65
                if ($age > 65): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php 
                // Display age advantage research for users over 25
                if ($age > 25): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php 
                // Display sleep and injury research
                if ($sleep > 7 && $isInjury): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php 
                // Display protein research for low protein intake
                if ($proteinIntake < $result['minProtein']): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php 
                // Display protein and injury research
                if ($proteinIntake < $result['minProtein'] && $isInjury): ?>
                <div class="bg-white p-4 rounded-lg shadow-md border border-green-100">
                ...
                <?php
                // Count research cards to ensure minimum display
                $researchCardCount = 0;
                ...
                // Display additional research if needed
